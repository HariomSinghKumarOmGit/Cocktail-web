...
const Menu = () => {
  ...
  return (
    <section id="menu" aria-labelledby='menu-heading'>
      ...
      <h2 id="nemu-heading" className='sr-only' >
        Cocktail Menu
      </h2>

      <nav className="cocktail-tabs" aria-labelledby='cocktails navigation' >
        ...
        <div className='content'>
            ...
            <div className='recipe'>
                <div ref={constentRef} className='info' >
                    <p>Recipe for:</p>
